-- CreateEnum
CREATE TYPE "MessageRole" AS ENUM ('USER', 'SYSTEM', 'ASSISTENT', 'TOOL');

-- CreateEnum
CREATE TYPE "MessageStatus" AS ENUM ('PENDING', 'ERROR', 'COMPLTETE');
...
CREATE TABLE "Message" (
    ...
    "status" "MessageStatus" NOT NULL DEFAULT 'COMPLTETE',
